    ...
    <>
      <Grid container spacing={10}>
        {cart.line_items.map((item) => (
          ...
          <CartItem item={item} onUpdateCardQuantity={handleUpdateCartQuantity} onRemoveFromCart={handleRemoveFromCart}/>
          </Grid>
         ))}
      </Grid>
      <div className={classes.cardDetails}>
        ...
        <div>
          ...
          <Button component={Link} to="/checkout" className={classes.checkoutButton} sz="large" type="button" variant="contained" color="primary">Checkout</Button>
        </div>
      </div>
    </>
  )
